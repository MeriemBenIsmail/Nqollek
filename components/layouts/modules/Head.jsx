...
const StyleSheets = () => (
    <Head>
        ...
        <meta name="keywords" content="NqollekHaja, React, eCommerce, Template" />
        <meta name="description" content="NqollekHaja - React eCommerce Template" />
        <link
