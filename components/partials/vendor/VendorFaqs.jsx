    ...
    <div className="ps-section--vendor ps-vendor-faqs">
        <div className="container">
            <div className="ps-section__header">
                ...
                <h4>Here are some common questions about selling on UTOPIKA</h4>
            </div>
            <div className="ps-section__content">
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            <figcaption>How do fees work on UTOPIKA?</figcaption>
                            <p>
                                Joining and starting a shop on UTOPIKA is free. There are three
                        ...
                        <figure>
                            ...
                            <p>
                                It’s easy to set up a shop on UTOPIKA. Create an UTOPIKA account
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            ...
                            <p>
                                ...
                                UTOPIKA will be deposited into your PayPal account. We encourage
                        ...
                        <figure>
                            <figcaption>What can I sell on UTOPIKA?</figcaption>
                        </figure>
                        <p>
                            UTOPIKA provides a marketplace for crafters, artists and collectors to
