            ...
            <div className="ps-section__wrapper">
                <div className="ps-section__left">
                    ...
                    <aside className="widget widget--vendor">
                        ...
                        <div className="form-group">
                            <Select placeholder="Choose Location" style={{ width: '100%' }}>
                        ...
                        <div className="form-group">
                            <Select placeholder="Chooose State" style={{ width: '100%' }}>
                    ...
                    <section className="ps-store-box">
                        <div className="ps-section__header">
                            ...
                            <Select
                                ...
                                <Option key="1">Sort by Newest: old to news</Option>
                                <Option key="2">Sort by Newest: New to old</Option>
                                <Option key="3">Sort by average rating: low to hight</Option>
                            </Select>
                        </div>
                                    ...
                                    <article className="ps-block--store">
                                        ...
                                        <div className="ps-block__content">
                                            ...
                                            <ul className="ps-block__contact">
                                                ...
                                                <li>
                                                    <i className="icon-telephone"></i> (+093)
                                                    77-637-3300
                                                </li>
                                            </ul>
                                            <div className="ps-block__inquiry">
                                                <a href="#">
                                                    <i className="icon-question-circle"></i> inquiry
                                                </a>
                                            </div>
                                        </div>
                                    </article>
