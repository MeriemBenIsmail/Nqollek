    ...
    <div className="ps-section--vendor ps-vendor-faqs">
        <div className="container">
            <div className="ps-section__header">
                ...
                <h4>Here are some common questions about selling on NqollekHaja</h4>
            </div>
            <div className="ps-section__content">
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            <figcaption>How do fees work on NqollekHaja?</figcaption>
                            <p>
                                Joining and starting a shop on NqollekHaja is free. There are three
                        ...
                        <figure>
                            ...
                            <p>
                                It’s easy to set up a shop on NqollekHaja. Create an NqollekHaja account
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            ...
                            <p>
                                ...
                                NqollekHaja will be deposited into your PayPal account. We encourage
                        ...
                        <figure>
                            <figcaption>What can I sell on NqollekHaja?</figcaption>
                        </figure>
                        <p>
                            NqollekHaja provides a marketplace for crafters, artists and collectors to
