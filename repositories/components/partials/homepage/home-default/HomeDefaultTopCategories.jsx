            ...
            <div className="row">
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 ">
                    <div className="ps-block--category">
                        ...
                        <img src="/static/img/categories/6.jpg" alt="NqollekHaja" />
                        <p>Health & Beauty</p>
                    </div>
                </div>
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 ">
                    <div className="ps-block--category">
                        ...
                        <img src="/static/img/categories/7.jpg" alt="NqollekHaja" />
                        <p>Jewelry & Watch</p>
                    </div>
                </div>
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 ">
                    <div className="ps-block--category">
                        ...
                        <img src="/static/img/categories/8.jpg" alt="NqollekHaja" />
                        <p>Technology Toys</p>
                    </div>
                </div>
            </div>
