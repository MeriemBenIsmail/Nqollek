...
class MarketPlaceHomeBanner extends Component {
    constructor(props) {
        super(props);
    }
            ...
            <section className="ps-home-banner">
                <Slider {...carouselSettings} className="ps-carousel">
                    <div
                        ...
                        <img src="/static/img/slider/home-3/home-banner/1.jpg" alt="NqollekHaja" />
                    ...
                    <div
                        ...
                        <img src="/static/img/slider/home-3/home-banner/2.jpg" alt="NqollekHaja" />
                        <div className="ps-banner__content">
